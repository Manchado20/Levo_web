...
export const courses = [
    {
        ...
        description: 'Traduce las palabras de las tarjetas lo más rápido posible',
        category   : 'isc',
        timeLimit  : true,
        available  : true,
        wordsRound : 10,
    ...
    },
    {
        ...
        description: 'Rellena los recuadros para completar las palabras',
        category   : 'isc',
        timeLimit  : true,
        available  : false,
        wordsRound : 10,
        gameModes  : 'Identificar, Escribir',
        totalSteps : 11,
    ...
    },
    {
        ...
        title      : 'Spelling Bee',
        slug       : 'build-an-app-for-the-google-assistant-with-firebase',
        description: 'Escucha la palabra y un ejemplo de uso, y deletrea',
        category   : 'isc',
        timeLimit  : false,
        available  : false,
        wordsRound : 5,
        gameModes  : 'Escuchar, Deletrear',
        totalSteps : 11,
        updatedAt  : 'Jan 09, 2021',
        featured   : false,
        progress   : {
    ...
    },
    {
        ...
        title      : 'Type or Die',
        slug       : 'build-an-app-for-the-google-assistant-with-firebase',
        description: 'Escribe todas las palabras antes de que caigan al suelo',
        category   : 'isc',
        timeLimit  : false,
        available  : false,
        wordsRound : 20,
        gameModes  : 'Leer, Escribir',
        totalSteps : 11,
        updatedAt  : 'Jan 09, 2021',
        featured   : false,
        progress   : {
